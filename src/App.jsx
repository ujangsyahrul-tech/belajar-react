  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content" id="beranda">
        ...
        <section className="welcome-section"><div><p className="eyebrow">KAMIS, 27 AGUSTUS 2026</p><h1>Selamat pagi, Agus <span className="wave">✦</span></h1><p className="intro">Lanjutkan perjalananmu membangun antarmuka yang <strong>lebih hidup.</strong></p></div><div className="streak"><span className="streak-icon">✹</span><div><strong>5 hari</strong><small>streak belajar</small></div></div></section>
